...
<!-- BEGIN Header -->
	<div id="header-wrapper">	
			<!-- logo -->
			<div id="logo">
									<a href="./" title="Home"><img src="/tuition/resources/images/logo.png" alt="Temasek Tutors | Tuition Services, Singapore"></a>	
							</div>	
...
<c:forEach var="assignment" items="${assignmentList}">
	...
	<tbody><tr><td class="Descriptor request_id" colspan="3">Request ID: ${assignment.id} &nbsp;&nbsp;&nbsp;,&nbsp;&nbsp;&nbsp; Super near Bishan Mrt</td><td class="assignment_status" colspan="1" align="right"><img src="/tuition/resources/images/new_request_logo2.png"></td></tr>
	<tr><td class="Descriptor">Gender Preference: </td><td>${assignment.genderPerference}</td><td class="Descriptor">Subject/Level: </td><td>Sec-2 - English<br></td></tr>
	...
	<tr><td class="recent_assignment_info" colspan="2"><b>Assignment Information: </b><br>information not available</td><td colspan="2" align="right"><div class="recent_assignment_bid" id="25739"><div class="" id="25739"><a class="" id="25739" href="./recent_assignments?q=redirecter/login"><img src="/tuition/resources/images/btn_bid_assgn.gif"></a></div></div></td></tr>
