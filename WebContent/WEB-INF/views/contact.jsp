...
<title>
Contact Us | Temasek Tutors | Tuition Services, Singapore</title>
	...
	<div id="main-wrapper">
		...
		<div id="content-region-none">	
			...
			<!-- title -->
				...
				<div class="yellow_header">Contact Us</div>			</h2>
...
<div><div id="contact_column1"><div id="contact_pic"><img src="resources/images/operator.jpg" height="240" width="340"></div><div id="contact_info_block"><div id="contact_info_text">Alternatively, you can call the following number to talk to our tutor coordinators.<br><br>
					<b>Contact Number:</b><br>&nbsp;&nbsp;65574130<br><br>
					<b>Operating Hours:</b><br>&nbsp;&nbsp;Monday to Sunday, 9am to 9pm.</div></div></div><div id="contact_form">You can get in touch with us using the contact form below. Depending on your query, we may take up to 2 days to get back to you.

Thank You<div class="form-item">
 <label for="edit-name">Your name: <span class="form-required" title="This field is required.">*</span></label>
 <input style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-position: right center; cursor: auto;" maxlength="255" name="name" id="edit-name" size="60" class="form-text required" type="text">
</div>
<div class="form-item">
 <label for="edit-mail">Your e-mail address: <span class="form-required" title="This field is required.">*</span></label>
 <input maxlength="255" name="mail" id="edit-mail" size="60" class="form-text required" type="text">
</div>
<div class="form-item">
 <label for="edit-subject">Subject: </label>
 <input maxlength="255" name="subject" id="edit-subject" size="60" class="form-text" type="text">
</div>
<div class="form-item">
 <label for="edit-message">Message: <span class="form-required" title="This field is required.">*</span></label>
 <textarea cols="50" rows="10" name="message" id="edit-message" class="form-textarea required"></textarea>
</div>
<input name="seed" id="edit-seed" value="373cf2881425e6c04209e73eb468d37c" type="hidden">
<img src="resources/images/373cf2881425e6c04209e73eb468d37c.jpg"><div class="form-item">
...
</div><input name="form_id" id="edit-contact-mail-page" value="contact_mail_page" type="hidden">
